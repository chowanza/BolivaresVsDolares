...
def get_rates():
    ...
    try:
        ...
        print("BCV Rate:", monitor.get_value_monitors())
    ...
    try:
        ...
        print("EnParaleloVzla Rate:", monitor.get_value_monitors())
    except Exception as e:
    ...
    try:
        ...
        print("ExchangeMonitor Rate:", monitor.get_value_monitors())
    except Exception as e:
    ...
    try:
        ...
        print("CriptoDolar Rate:", monitor.get_value_monitors())
    except Exception as e:
